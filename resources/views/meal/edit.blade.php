...
<div Style="background-color:white;border-bottom: 0.9px solid gray;color:gray;">           
         ...
         <h2> <i class="fas fa-plus"> Edit Meal</i> </h2> 
        </div>
		   </div>
        </div>
...
{{method_field('PATCH')}}
   <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="description" value="{{$meal->description}}" class="form-control" placeholder="description">
            </div>
        </div>
		   <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Price:</strong>
                <input type="text" name="price" value="{{$meal->price}}" class="form-control" placeholder="Price">
            </div>
        </div>
   <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
